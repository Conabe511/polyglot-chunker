...
Tools for building PNG/MPEG-TS polyglot files (in this case, files that are simultaneously a valid PNG image and a valid MPEG-TS stream), and for chunking a video into a folder of such polyglots with an accompanying HLS playlist.
...
**Requirements:** Python 3.8+, ffmpeg/ffprobe in PATH, and png_ts_polyglot.py in the same folder
...
> Generated by Myself.ai, some code and all docs contributed by Claude
